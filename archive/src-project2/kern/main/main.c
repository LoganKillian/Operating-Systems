...
#include <synch.h>
#include <thread.h>
//This is a comment (Logan Killian)
...
//Below are 10 debugging messages
DEBUG(DB_VM, "VM free pages: %u\n", free_pages);
DEBUG(DB_VM, "VM free pages: %u\n", free_pages);
DEBUG(DB_VM, "VM free pages: %u\n", free_pages);
DEBUG(DB_SYSCALL, "SYSCALL free pages: %u\n", free_pages);
DEBUG(DB_LOCORE, "LOCORE free pages: %u\n", free_pages);
DEBUG(DB_INTERRUPT, "INTERRUPT free pages: %u\n", free_pages);
DEBUG(DB_DEVICE, "DEVICE free pages: %u\n", free_pages);
DEBUG(DB_THREADS, "THREADS free pages: %u\n", free_pages);
DEBUG(DB_EXEC, "EXEC free pages: %u\n", free_pages);
DEBUG(DB_VFS, "VFS free pages: %u\n", free_pages);
DEBUG(DB_SFS, "SFS free pages: %u\n", free_pages);
DEBUG(DB_NET,"NET free pages: %u\n", free_pages);
